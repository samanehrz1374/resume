...
class ProfileModel(models.Model):
    ...
    # skill = models.CharField(max_length=50,null=True,verbose_name="مهارت ها")
    # course = models.CharField(max_length=50,null=True,verbose_name="دوره های آموزشی")
    # language = models.CharField(max_length=50,null=True,verbose_name="زبان ها")
    # award = models.CharField(max_length=50,null=True,verbose_name="جوایز")
    # project = models.CharField(max_length=50,null=True,verbose_name="پروژه ها")
    # article = models.CharField(max_length=50,null=True,verbose_name="مقالات")
    # job = models.CharField(max_length=50,null=True,verbose_name="سوابق شغلی")
    # aducation = models.CharField(max_length=50,null=True,verbose_name="تحصیلات")
