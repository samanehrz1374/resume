...
let totalForms1 = document.querySelector("#id_form1-TOTAL_FORMS")
...
function addForm1(e){
    ...
    let formRegex = RegExp(`form1-(\\d){1}-`,'g')

    formNum1++
    newForm.innerHTML = newForm.innerHTML.replace(formRegex, `form1-${formNum1}-`)
...
let totalForms2 = document.querySelector("#id_form3-TOTAL_FORMS")
...
function addForm2(e){
    ...
    let formRegex = RegExp(`form3-(\\d){1}-`,'g')

    formNum2++
    newForm.innerHTML = newForm.innerHTML.replace(formRegex, `form3-${formNum2}-`)
...
let totalForms3 = document.querySelector("#id_form5-TOTAL_FORMS")
let formNum3 = birdForm3.length-1
addButton3.addEventListener('click', addForm3)
function addForm3(e){
    e.preventDefault()
    let newForm = birdForm3[0].cloneNode(true)
    let formRegex = RegExp(`form5-(\\d){1}-`,'g')
    formNum3++
    newForm.innerHTML = newForm.innerHTML.replace(formRegex, `form5-${formNum3}-`)
...
let totalForms4 = document.querySelector("#id_form7-TOTAL_FORMS")
...
function addForm4(e){
    ...
    let formRegex = RegExp(`form7-(\\d){1}-`,'g')

    formNum4++
    newForm.innerHTML = newForm.innerHTML.replace(formRegex, `form7-${formNum4}-`)
...
let totalForms5 = document.querySelector("#id_form9-TOTAL_FORMS")
...
function addForm5(e){
    ...
    let formRegex = RegExp(`form9-(\\d){1}-`,'g')

    formNum5++
    newForm.innerHTML = newForm.innerHTML.replace(formRegex, `form9-${formNum5}-`)
...
let totalForms6 = document.querySelector("#id_form11-TOTAL_FORMS")
...
function addForm6(e){
    ...
    let formRegex = RegExp(`form11-(\\d){1}-`,'g')

    formNum6++
    newForm.innerHTML = newForm.innerHTML.replace(formRegex, `form11-${formNum6}-`)
...
let totalForms7 = document.querySelector("#id_form13-TOTAL_FORMS")
...
function addForm7(e){
    ...
    let formRegex = RegExp(`form13-(\\d){1}-`,'g')

    formNum7++
    newForm.innerHTML = newForm.innerHTML.replace(formRegex, `form13-${formNum7}-`)
...
let totalForms8 = document.querySelector("#id_form15-TOTAL_FORMS")
...
function addForm8(e){
    ...
    let formRegex = RegExp(`form15-(\\d){1}-`,'g')

    formNum8++
    newForm.innerHTML = newForm.innerHTML.replace(formRegex, `form15-${formNum8}-`)
